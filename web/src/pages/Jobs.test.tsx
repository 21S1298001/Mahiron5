...
describe("Jobs", () => {
  it("renders service scan result details with service names", () => {
    const dashboard = {
      data: { status: null, tuners: null, services: null, jobs: null, programs: null },
      ...
      jobs: resource<Job[]>([
        {
          ...
          result: {
            ...
            counts: { newNetworks: 1, existingServices: 0, services: 2, addedServices: 1, removedServices: 0 },
            items: [
              {
                kind: "service",
                summary: "NHK",
