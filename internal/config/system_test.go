	...
	tests := []struct {
		...
		},
		{
			...
			want: &SystemConfig{
				...
				Observability: ObservabilityConfig{ServiceName: "mahiron5"}, MaxConcurrentJobs: 1, DatabasePath: "./mahiron.db",
				EpgRetentionDays: 3, EpgRetrievalTime: 600000, EpgStaleAfter: 7200000, LogoGatherTimeout: 600000,
			},
		},
		{
			...
			want: &SystemConfig{
				Addresses: []ServerAddress{{Http: "localhost:40772"}}, LogLevel: "info",
				Observability: ObservabilityConfig{ServiceName: "mahiron5"}, MaxConcurrentJobs: 4, DatabasePath: "./mahiron.db",
				EpgRetentionDays: 3, EpgRetrievalTime: 600000, EpgStaleAfter: 7200000, LogoGatherTimeout: 1200000,
			},
		},
		{
