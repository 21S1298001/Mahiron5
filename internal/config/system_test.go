	...
	tests := []struct {
		...
		},
		{
			...
			want: &SystemConfig{
				...
				Observability: ObservabilityConfig{ServiceName: "mahiron"}, MaxConcurrentJobs: 1, DatabasePath: "./mahiron.db",
		...
		},
		{
			...
			want: &SystemConfig{
				Addresses: []ServerAddress{{Http: "localhost:40772"}}, LogLevel: "info",
				Observability: ObservabilityConfig{ServiceName: "mahiron"}, MaxConcurrentJobs: 4, DatabasePath: "./mahiron.db",
